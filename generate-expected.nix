# This expression records the integration test replay files tested when building
...
#
# To rotate the integration test replay files, build this from the flake, and then copy the
# integration test replay files from the result.
{ system }:
