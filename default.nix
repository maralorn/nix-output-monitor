...
, hermes-json, HUnit, lib, nix-derivation, optics, pretty-simple
, random, relude, safe, safe-exceptions, stm, streamly-core, strict
...
mkDerivation {
  ...
  testHaskellDepends = [
    ...
    optics pretty-simple random relude safe safe-exceptions stm
